        ...
        <Formik 
            ...
            validationSchema={Yup.object({
                ...
                email: Yup.string()
                    ...
                    .test('EMAIL_FORMAT', 
                        'Email already taken!',
                        (value) => !checkUniqueEmail().includes(value) || singleUser?.email  === value
                    ), 
                adress: Yup.string()
                    .max(50, "Too Long!"),
            ...
            {({ values, setFieldValue, errors, touched }) =>(
                <Form className="profile_form">
                    <div className="profile_first_box">
                        ...
                        />
                        <ErrorMessage className="text_error" name="dateofbirth" component="div"/>
                    </div>
                    <div className="profile_second_box">
                        ...
                        <ErrorMessage className="text_error" name="gender" component="div"/>
                    </div>
                    ...
                    {profileName && !singleUser ? <div className="text_error_button">Fill out the previous form</div> : null}
                </Form>
            )}
        </Formik>
    )
